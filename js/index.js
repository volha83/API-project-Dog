...
/* fetch API-10 - Select 10 random photo of the dogs*/
...
/* API choice 1 dog and more info about breeds*/
  ...
  fetch(apiDog)
    ...
    .then((dogs) => {
      dogs.forEach((dog) => {
        ...
        document.getElementById("but_submit").addEventListener("click", function () {
            projectList.appendChild(breed).style.display = "";
          });
        /*At first the name of the breed is hidden*/
